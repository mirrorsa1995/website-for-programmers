...
<body>
    <header>
        ...
        <div class="navbar">
            <nav class="navigation hide" id="navigation">
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item"><a href="/layouts/posts.php">Posts</a></li>
                    <li class="nav-item"><a href="/layouts/detail.php">My Profile</a></li>
                    <li class="nav-item"><a href="/layouts/addpost.php">Add post</a></li>
                    <?php
                    if (!$_SESSION['user']) {
                        ?>
                    <li class="nav-item"><a href="/layouts/login.php">Login</a></li>
                    <li class="nav-item"><a href="/layouts/registration.php">Registration</a></li>
                        <?php
                    }
                    ?>
                </ul>
        ...
        if ($_SESSION['user']) {
            ...
            <a href="logout.php" class="/layouts/logout.php">Выход</a>
            <?php
        }
        ?>
        <!--SearchBox Section-->
